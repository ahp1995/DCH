...
def mk_cifar10_lfa(data_path, dst_train, num_classes):
    ...
    # make dir for ImageFolder
    if not os.path.exists(data_path + '/cifar10_lfa'):
        os.mkdir(data_path + '/cifar10_lfa')
        for i in range(10):
            os.mkdir(data_path + '/cifar10_lfa/{}'.format(i))
    ...
    for i in range(50000):
        ...
        # 3 laplacian mask
        laplacian1 = cv2.filter2D(gray, -1, mask3)
        laplacian2 = cv2.filter2D(gray, -1, mask3)
        laplacian3 = cv2.filter2D(gray, -1, mask3)
        ...
        for j in range(10):
            if i in indices_class[j]:
                cv2.imwrite(data_path + '/cifar10_lfa/{0}/img{1}.png'.format(j, i), laplacian_img)



def mk_cifar100_lfa(data_path, dst_train, num_classes):
    ...
    # make dir for ImageFolder
    if not os.path.exists(data_path + '/cifar100_lfa'):
        os.mkdir(data_path + '/cifar100_lfa')
        for i in range(100):
            os.mkdir(data_path + '/cifar100_lfa/{}'.format(i))
    ...
    for i in range(50000):
        ...
        for j in range(100):
            if i in indices_class[j]:
                cv2.imwrite(data_path + '/cifar100_lfa/{0}/img{1}.png'.format(j, i), laplacian_img)